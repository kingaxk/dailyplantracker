...
const RECIPES = [
  { id:"zupa_papryka", name:"Zupa z pieczonej papryki", meals:["obiad","lunch","kolacja"], portions:1,
    ...
    instructions:[
      "Papryki przekrój na pół, oczyść z pestek, ułóż na blaszce skórką do góry. Piecz w 200°C (termoobieg) ok. 25-30 minut, aż skórka sczernieje i pomarszczy się.",
      "Przełóż upieczoną paprykę do miski, przykryj folią na 10 minut — dzięki temu skórka łatwo zejdzie. Obierz ze skórki.",
      "W międzyczasie ugotuj ziemniaka w osolonej wodzie do miękkości.",
      "Na oliwie zeszklij cebulę z czosnkiem.",
      "Dodaj upieczoną paprykę, ugotowanego ziemniaka i bulion. Zagotuj.",
      "Zblenduj całość na gładki krem, dodaj mleczko kokosowe i wędzoną paprykę, dopraw solą i pieprzem.",
      "Podawaj z wybranym białkiem na wierzchu."
    ],
    fixed:[
      {name:"Papryka czerwona",amount:300,unit:"g"},
      {name:"Ziemniak",amount:150,unit:"g"},
      {name:"Cebula",amount:50,unit:"g"},
      {name:"Czosnek",amount:2,unit:"ząbek"},
      {name:"Bulion warzywny",amount:400,unit:"ml"},
      {name:"Mleczko kokosowe (light)",amount:60,unit:"ml"},
      {name:"Oliwa z oliwek",amount:12,unit:"g"},
      {name:"Wędzona papryka (przyprawa)",amount:1,unit:"łyżeczka"},
    ],
    variantGroups:[
  ...
  { id:"salatka_komosa_marchew", name:"Sałatka z komosą, tartą marchewką i sosem z masła orzechowego", meals:["obiad","lunch","kolacja"], portions:1,
    ...
    instructions:[
      ...
      "Tofu pokrój w kostkę i krótko podsmaż na suchej patelni lub skrop odrobiną sosu sojowego.",
      "Wymieszaj komosę z marchewką, kapustą, ogórkiem i tofu, polej sosem orzechowym tuż przed podaniem, posyp kolendrą lub szczypiorkiem."
    ],
    fixed:[
      ...
      {name:"Tofu wędzone",amount:60,unit:"g"},
  ...
  { id:"dal_soczewica", name:"Dal z czerwonej soczewicy", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:[],
    ...
    fixed:[
      {name:"Soczewica czerwona (sucha)",amount:70,unit:"g"},
      {name:"Cebula",amount:60,unit:"g"},
      {name:"Czosnek",amount:1,unit:"ząbek"},
      {name:"Imbir świeży",amount:6,unit:"g"},
      {name:"Pomidory krojone (puszka)",amount:120,unit:"g"},
      {name:"Mleczko kokosowe (light)",amount:95,unit:"ml"},
      {name:"Olej lub ghee",amount:14,unit:"g"},
      {name:"Kurkuma, kumin, kolendra (przyprawy)",amount:1,unit:"łyżeczka"},
    ],
    variantGroups:[],
  },
  { id:"frittata_piekarnikowa", name:"Frittata z warzywami i serem", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:["do_salatek"],
    ...
    fixed:[
      {name:"Jajka",amount:4,unit:"sztuka"},
      {name:"Papryka",amount:60,unit:"g"},
      {name:"Cukinia",amount:60,unit:"g"},
      {name:"Cebula",amount:35,unit:"g"},
  ...
  { id:"salatka_halloumi", name:"Ciepła sałatka z grillowanym halloumi i miodem", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:[],
    ...
    instructions:[
      "Cukinię pokrój w plastry i podsmaż lub zgrilluj z obu stron, aż zmięknie i lekko się zarumieni. Odłóż na bok.",
      ...
      "Na wierzchu ułóż ciepłe plastry cukinii i halloumi.",
      "Skrop miodem, oliwą i octem balsamicznym, posyp orzechami lub pestkami dyni. Podawaj od razu, dopóki ser jest ciepły."
    ],
    fixed:[
      {name:"Halloumi",amount:95,unit:"g"},
      {name:"Cukinia",amount:80,unit:"g"},
      {name:"Mix sałat",amount:1,unit:"garść"},
      {name:"Pomidorki koktajlowe",amount:70,unit:"g"},
      {name:"Miód",amount:10,unit:"g"},
      {name:"Orzechy lub pestki dyni",amount:14,unit:"g"},
      {name:"Oliwa z oliwek",amount:7,unit:"g"},
      {name:"Ocet balsamiczny",amount:1,unit:"łyżeczka"},
    ],
    variantGroups:[],
  },
  { id:"ratatouille", name:"Ratatouille", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:[],
    ...
    instructions:[
      ...
      "Podsmaż lub zgrilluj plastry halloumi (lub przygotuj wybrany dodatek białkowy) i podawaj na wierzchu ratatouille, razem z wybraną bazą."
    ],
    fixed:[
      {name:"Bakłażan",amount:105,unit:"g"},
      {name:"Cukinia",amount:105,unit:"g"},
      {name:"Papryka",amount:105,unit:"g"},
      {name:"Pomidory krojone (puszka)",amount:160,unit:"g"},
      {name:"Cebula",amount:50,unit:"g"},
      {name:"Czosnek",amount:2,unit:"ząbek"},
      {name:"Oliwa z oliwek",amount:13,unit:"g"},
      {name:"Zioła prowansalskie",amount:1,unit:"łyżeczka"},
    ],
    variantGroups:[
      { id:"bialko", label:"Dodatek białkowy", options:[
        { id:"halloumi", label:"Halloumi", ingredients:[{name:"Ser halloumi",amount:35,unit:"g"}] },
        { id:"fasola", label:"Fasola biała", ingredients:[{name:"Fasola biała (z puszki)",amount:105,unit:"g"}] },
        { id:"kozi", label:"Ser kozi", ingredients:[{name:"Ser kozi",amount:40,unit:"g"}] },
      ]},
  ...
  { id:"makaron_pomidorowy", name:"Makaron w sosie pomidorowo-bazyliowym z mozzarellą", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:[],
    ...
    fixed:[
      {name:"Makaron",amount:70,unit:"g"},
      {name:"Pomidory krojone (puszka) lub passata",amount:230,unit:"g"},
  ...
  { id:"curry_ciecierzyca", name:"Curry z ciecierzycą i szpinakiem", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:[],
    ...
    fixed:[
      ...
      {name:"Ciecierzyca z puszki",amount:130,unit:"g"},
      {name:"Szpinak świeży",amount:105,unit:"g"},
      {name:"Mleczko kokosowe (light)",amount:85,unit:"ml"},
      {name:"Pomidory krojone (puszka)",amount:105,unit:"g"},
  ...
  { id:"zupa_dynia", name:"Zupa krem z dyni", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:["do_zup"],
    ...
    fixed:[
      {name:"Dynia (obrana, kostka)",amount:465,unit:"g"},
      {name:"Cebula",amount:0.5,unit:"sztuka"},
      {name:"Czosnek",amount:1,unit:"ząbek"},
    ...
    variantGroups:[
      ...
      { id:"pestki", label:"Pestki dyni (opcjonalnie)", options:[
        { id:"brak", label:"Bez", ingredients:[] },
        { id:"tak", label:"Dodaj", ingredients:[{name:"Pestki dyni",amount:11,unit:"g"}] },
      ]},
    ],
  },
  { id:"shakshuka", name:"Shakshuka", meals:["sniadanie","lunch","kolacja"], portions:1,
    addonTags:[],
    ...
    fixed:[
      ...
      {name:"Pomidory krojone (puszka)",amount:240,unit:"g"},
    ...
    variantGroups:[
      { id:"feta", label:"Feta na wierzch (opcjonalnie)", options:[
        { id:"brak", label:"Bez", ingredients:[] },
        { id:"tak", label:"Dodaj", ingredients:[{name:"Feta",amount:25,unit:"g"}] },
      ]},
    ],
  },
  { id:"salatka_komosa", name:"Sałatka z komosą ryżową, fetą i granatem", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:["do_salatek"],
    ...
    instructions:[
      ...
      "Wymieszaj komosę z ogórkiem, rukolą, fetą, pestkami granatu i orzechami.",
      "Skrop oliwą i sokiem z cytryny tuż przed podaniem."
    ],
    fixed:[
      {name:"Komosa ryżowa (sucha)",amount:55,unit:"g"},
      {name:"Feta",amount:55,unit:"g"},
      {name:"Granat (pestki)",amount:40,unit:"g"},
      {name:"Ogórek",amount:55,unit:"g"},
      {name:"Rukola",amount:1,unit:"garść"},
      {name:"Oliwa z oliwek",amount:5,unit:"g"},
      {name:"Orzechy (posiekane)",amount:11,unit:"g"},
    ],
    variantGroups:[],
  },
  { id:"losos_pieczony", name:"Łosoś pieczony z warzywami", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:["do_obiadu"],
    ...
    fixed:[
      {name:"Łosoś (filet)",amount:175,unit:"g"},
      {name:"Cukinia",amount:115,unit:"g"},
      {name:"Papryka",amount:115,unit:"g"},
      {name:"Cebula czerwona",amount:60,unit:"g"},
      {name:"Oliwa z oliwek",amount:14,unit:"g"},
      {name:"Cytryna",amount:0.25,unit:"sztuka"},
      {name:"Koperek",amount:1,unit:"szczypta"},
    ],
    variantGroups:[],
  },
  { id:"placki_cukiniowe", name:"Placki cukiniowe", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:["do_salatek"],
    ...
    fixed:[
      {name:"Cukinia (starta, odciśnięta)",amount:375,unit:"g"},
    ...
    variantGroups:[
      { id:"serek", label:"Serek wiejski (opcjonalnie)", options:[
        { id:"brak", label:"Bez", ingredients:[] },
        { id:"tak", label:"Dodaj", ingredients:[{name:"Serek wiejski lekki",amount:50,unit:"g"}] },
      ]},
    ],
  },
  { id:"chili_sin_carne", name:"Chili sin carne z fasolą i batatami", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:["do_obiadu"],
    ...
    fixed:[
      {name:"Fasola czerwona (z puszki)",amount:175,unit:"g"},
      {name:"Batat",amount:175,unit:"g"},
      {name:"Pomidory krojone (puszka)",amount:175,unit:"g"},
      {name:"Cebula",amount:60,unit:"g"},
      {name:"Papryka",amount:60,unit:"g"},
      {name:"Czosnek",amount:1,unit:"ząbek"},
      {name:"Oliwa z oliwek",amount:14,unit:"g"},
  ...
  { id:"krewetki_czosnkowe", name:"Krewetki czosnkowe z limonką i ryżem", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:["do_warzyw"],
    ...
    fixed:[
      {name:"Krewetki (obrane)",amount:175,unit:"g"},
      {name:"Brokuły",amount:115,unit:"g"},
      {name:"Ryż",amount:55,unit:"g"},
      {name:"Czosnek",amount:2,unit:"ząbek"},
      {name:"Masło",amount:14,unit:"g"},
      {name:"Limonka",amount:0.5,unit:"sztuka"},
      {name:"Chili w płatkach",amount:1,unit:"szczypta"},
    ],
    variantGroups:[],
  },
  { id:"smoothie_bowl", name:"Smoothie bowl owocowe", meals:["sniadanie","lunch","kolacja"], portions:1,
    addonTags:[],
    description:"Zimne, orzeźwiające śniadanie na gęsto — świetne na upalne dni, je się łyżką jak owsiankę.",
    instructions:[
      "Zblenduj mrożonego banana, mrożone owoce i wybraną bazę białkową na gęsty, kremowy mus (bez dodawania wody).",
      "Przełóż do miski.",
      "Udekoruj granolą i wybranymi opcjonalnymi dodatkami."
    ],
    fixed:[
      {name:"Banan (mrożony)",amount:160,unit:"g"},
      {name:"Owoce mrożone (jagody/mango)",amount:135,unit:"g"},
      {name:"Granola",amount:35,unit:"g"},
    ],
    variantGroups:[
      { id:"baza", label:"Baza białkowa", options:[
        { id:"skyr", label:"Skyr naturalny", ingredients:[{name:"Skyr naturalny",amount:200,unit:"g"}] },
        { id:"wiejski", label:"Serek wiejski", ingredients:[{name:"Serek wiejski lekki",amount:200,unit:"g"}] },
      ]},
      { id:"miod", label:"Miód na wierzch (opcjonalnie)", options:[
        { id:"brak", label:"Bez", ingredients:[] },
        { id:"tak", label:"Dodaj", ingredients:[{name:"Miód",amount:9,unit:"g"}] },
      ]},
      { id:"orzechy", label:"Orzechy (opcjonalnie)", options:[
        { id:"brak", label:"Bez", ingredients:[] },
        { id:"tak", label:"Dodaj", ingredients:[{name:"Orzechy (posiekane)",amount:10,unit:"g"}] },
      ]},
      { id:"kakao", label:"Kakao (opcjonalnie)", options:[
        { id:"brak", label:"Bez", ingredients:[] },
        { id:"tak", label:"Dodaj", ingredients:[{name:"Kakao gorzkie",amount:5,unit:"g"}] },
      ]},
    ],
  },
  { id:"owsianka_marchew", name:"Owsianka z marchewką i rodzynkami", meals:["sniadanie","lunch","kolacja"], portions:1,
    ...
    variantGroups:[
      { id:"baza", label:"Baza płynna", options:[
        ...
        { id:"skyr", label:"Skyr z wodą", ingredients:[{name:"Skyr naturalny",amount:150,unit:"g"},{name:"Woda",amount:50,unit:"ml"}] },
      ]},
      { id:"slodkie", label:"Dodatek słodko-owocowy", options:[
        { id:"rodzynki", label:"Rodzynki", ingredients:[{name:"Rodzynki",amount:25,unit:"g"}] },
        { id:"daktyle", label:"Daktyle", ingredients:[{name:"Daktyle (posiekane)",amount:20,unit:"g"}] },
        { id:"miod", label:"Miód", ingredients:[{name:"Miód",amount:9,unit:"g"}] },
      ]},
    ],
  },
  { id:"kanapki", name:"Kanapki", meals:["sniadanie","obiad","lunch","kolacja"], portions:1,
  ...
  { id:"bowl_tofu", name:"Bowl z tofu lub tempehem", meals:["obiad","lunch","kolacja"], portions:1,
    ...
    fixed:[
      {name:"Fasola czerwona (z puszki)",amount:80,unit:"g"},
      {name:"Kukurydza",amount:35,unit:"g"},
      {name:"Ogórek",amount:80,unit:"g"},
      {name:"Rukola lub kiełki",amount:8,unit:"g"},
    ],
    variantGroups:[
      { id:"baza", label:"Baza", options:[
        { id:"ryz", label:"Ryż", ingredients:[{name:"Ryż",amount:40,unit:"g"}] },
        { id:"kasza", label:"Kasza gryczana / bulgur", ingredients:[{name:"Kasza gryczana lub bulgur",amount:40,unit:"g"}] },
      ]},
      { id:"bialko", label:"Białko", options:[
        { id:"tofu", label:"Tofu wędzone", ingredients:[{name:"Tofu wędzone",amount:80,unit:"g"}] },
        { id:"tempeh", label:"Tempeh", ingredients:[{name:"Tempeh",amount:80,unit:"g"}] },
      ]},
      { id:"surowka", label:"Surówka", options:[
        { id:"marchew", label:"Marchewka z sezamem", ingredients:[{name:"Surówka: marchewka z sezamem",amount:80,unit:"g"}] },
        { id:"kapusta", label:"Surówka z białej kapusty", ingredients:[{name:"Surówka z białej kapusty",amount:80,unit:"g"}] },
      ]},
  ...
  { id:"budyn_jaglany", name:"Budyń jaglany", meals:["sniadanie","lunch","kolacja"], portions:2,
    ...
    fixed:[
      {name:"Kasza jaglana",amount:130,unit:"g"},
      {name:"Mleko",amount:545,unit:"ml"},
      {name:"Ekstrakt z wanilii",amount:1,unit:"łyżeczka"},
      {name:"Skyr naturalny",amount:145,unit:"g"},
    ],
    variantGroups:[
      { id:"slodzik", label:"Słodzik", options:[
        { id:"banan", label:"Banan", ingredients:[{name:"Banan",amount:1.5,unit:"sztuka"}] },
        { id:"miod", label:"Miód", ingredients:[{name:"Miód",amount:35,unit:"g"}] },
      ]},
    ],
  },
  { id:"buleczki_tofu", name:"Bułeczki z tofu z nadzieniem", meals:["obiad","lunch","kolacja"], portions:2,
    addonTags:["do_salatek"],
    ...
    fixed:[
      {name:"Tofu naturalne",amount:245,unit:"g"},
      {name:"Jajka",amount:1,unit:"sztuka"},
      {name:"Mąka pszenna",amount:125,unit:"g"},
      {name:"Proszek do pieczenia",amount:1,unit:"łyżeczka"},
      {name:"Sól",amount:1,unit:"szczypta"},
      {name:"Pieczarki",amount:185,unit:"g"},
      {name:"Cebula",amount:0.5,unit:"sztuka"},
      {name:"Czosnek",amount:1,unit:"ząbek"},
      {name:"Oliwa z zalewy suszonych pomidorów",amount:1,unit:"łyżeczka"},
      {name:"Parmezan tarty",amount:18,unit:"g"},
      {name:"Pomidory suszone",amount:25,unit:"g"},
    ],
    variantGroups:[
  ...
  { id:"jajecznica", name:"Jajecznica", meals:["sniadanie","lunch","kolacja"], portions:1,
    ...
    instructions:["Na maśle/oleju zeszklij cebulę.", "Wlej roztrzepane jajka i usmaż luźną jajecznicę. Pod koniec smażenia posyp ją parmezanem, aby lekko się stopił. Zdejmij z patelni.", "Na tę samą, mocno rozgrzaną patelnię wrzuć pokrojonego pomidora. Smaż dosłownie 1 minutę na max mocy, aż złapie kolor, ale nie rozpadnie się na sos.", "Na tortilli ułóż rukolę, jajecznicę, ciepłego pomidora. Zwiń ciasno w rulon lub kopertę. Możesz krótko podpiec wrapa na suchej patelni lub grillu."],
    fixed:[
      {name:"Tortilla / chleb / bułka",amount:60,unit:"g"},
      {name:"Masło lub olej",amount:6,unit:"g"},
      {name:"Parmezan tarty",amount:6,unit:"g"},
      {name:"Pomidor",amount:150,unit:"g"},
      {name:"Rukola",amount:1,unit:"garść"},
      {name:"Cebula",amount:40,unit:"g"},
    ],
    variantGroups:[
      { id:"wersja", label:"Rozmiar jajek", options:[
        { id:"3m", label:"3 jajka M", ingredients:[{name:"Jajka",amount:3,unit:"sztuka"}] },
        { id:"2l", label:"2 jajka L", ingredients:[{name:"Jajka",amount:2,unit:"sztuka"}] },
      ]},
    ],
  },
  { id:"mus_orzechowy", name:"Mus orzechowy", meals:["sniadanie","lunch","kolacja"], portions:1,
    addonTags:[],
    ...
    variantGroups:[
      ...
      { id:"czekolada", label:"Tuning czekoladowy (opcjonalnie)", options:[
        { id:"brak", label:"Bez", ingredients:[] },
        { id:"kakao", label:"Kakao", ingredients:[{name:"Kakao gorzkie",amount:1.5,unit:"łyżeczka"}] },
  ...
  { id:"omlet_placuszki", name:"Omlet lub placuszki", meals:["sniadanie","obiad","lunch","kolacja"], portions:1,
    addonTags:[],
    ...
    fixed:[
      ...
      {name:"Twaróg chudy / skyr",amount:70,unit:"g"},
      {name:"Mąka pszenna lub owsiana",amount:40,unit:"g"},
      {name:"Olej lub masło",amount:3,unit:"g"},
      {name:"Proszek do pieczenia",amount:0.1,unit:"łyżeczka"},
      {name:"Owoce (maliny/borówki)",amount:70,unit:"g"},
    ],
    variantGroups:[
      { id:"slodzik", label:"Słodzik", options:[
        { id:"cukier", label:"Cukier", ingredients:[{name:"Cukier",amount:7,unit:"g"}] },
        { id:"erytrytol", label:"Erytrytol", ingredients:[{name:"Erytrytol",amount:1.5,unit:"łyżeczka"}] },
      ]},
    ],
  },
  { id:"owsianka_chia", name:"Owsianka z chia", meals:["sniadanie","lunch","kolacja"], portions:1,
    addonTags:[],
    ...
    fixed:[
      {name:"Płatki owsiane",amount:65,unit:"g"},
      {name:"Nasiona chia",amount:8,unit:"g"},
      {name:"Owoce (maliny/borówki/truskawki)",amount:115,unit:"g"},
    ],
    variantGroups:[
      { id:"baza", label:"Baza płynna", options:[
        { id:"skyr", label:"Skyr + woda", ingredients:[{name:"Skyr naturalny",amount:245,unit:"g"},{name:"Woda",amount:80,unit:"ml"}] },
        { id:"migdalowe", label:"Napój migdałowy", ingredients:[{name:"Napój migdałowy bez cukru",amount:420,unit:"ml"}] },
      ]},
      { id:"slodzik", label:"Dodatek słodzący", options:[
        { id:"miod", label:"Miód / syrop klonowy", ingredients:[{name:"Miód lub syrop klonowy",amount:16,unit:"g"}] },
        { id:"erytrytol", label:"Erytrytol", ingredients:[{name:"Erytrytol",amount:1.5,unit:"łyżeczka"}] },
      ]},
  ...
  { id:"pad_thai", name:"Pad thai z batatem i kapustą", meals:["obiad","lunch","kolacja"], portions:4,
    addonTags:["do_warzyw"],
    description:"",
    instructions:["Przygotuj sos: Wymieszaj składniki na sos. Wyciśnij sok z limonki, imbir zetrzyj na tarce, a czosnek przeciśnij przez praskę.", "Baza: Na oleju podsmaż czosnek i chili przeznaczone do Pad Thai.", "Białko: Podsmaż wybrane białko osobno, aż się zarumieni, i odłóż na bok.", "Bataty: Zetrzyj bataty na tarce i dodaj na patelnię, podsmażając przez około 3 minuty.", "Gotowanie: Dodaj poszatkowaną kapustę oraz 1/4 szklanki wody. Gotuj całość przez 5 minut. Następnie wlej przygotowany sos, dorzuć podsmażone białko i wymieszaj.", "Wykończenie: Na oddzielnej patelni podsmaż orzechy nerkowca. Gotowe danie posyp posiekanym szczypiorkiem i orzechami."],
    fixed:[
      {name:"Sos tamari lub sojowy",amount:25,unit:"ml"},
      {name:"Masło orzechowe",amount:45,unit:"g"},
      {name:"Limonki",amount:2,unit:"sztuka"},
      {name:"Olej sezamowy",amount:13,unit:"g"},
      {name:"Miód",amount:6,unit:"g"},
      {name:"Sos sriracha",amount:1,unit:"łyżeczka"},
      {name:"Imbir świeży",amount:9,unit:"g"},
      {name:"Czosnek",amount:3,unit:"ząbek"},
      {name:"Olej roślinny",amount:45,unit:"g"},
      {name:"Papryczki chili",amount:1.5,unit:"sztuka"},
      {name:"Nerkowce surowe",amount:60,unit:"g"},
      {name:"Bataty",amount:340,unit:"g"},
      {name:"Kapusta biała",amount:420,unit:"g"},
      {name:"Dymka (zielona cebulka)",amount:1.5,unit:"sztuka"},
    ],
    variantGroups:[
      { id:"bialko", label:"Białko", options:[
        { id:"tofu", label:"Tofu wędzone", ingredients:[{name:"Tofu wędzone",amount:340,unit:"g"}] },
        { id:"krewetki", label:"Krewetki", ingredients:[{name:"Krewetki (obrane)",amount:340,unit:"g"}] },
        { id:"kurczak", label:"Kurczak (pierś)", ingredients:[{name:"Pierś z kurczaka",amount:340,unit:"g"}] },
      ]},
    ],
  },
  { id:"pieczone_warzywa", name:"Pieczone warzywa (korzeniowe)", meals:["obiad","lunch","kolacja"], portions:1,
    ...
    fixed:[
      {name:"Miks warzyw korzeniowych (ziemniaki, buraki, marchew, pietruszka)",amount:370,unit:"g"},
      {name:"Cebula",amount:0.5,unit:"sztuka"},
      {name:"Olej / oliwa (do marynaty)",amount:10,unit:"g"},
    ],
    variantGroups:[
      { id:"bialko", label:"Białko", options:[
        { id:"ciecierzyca", label:"Ciecierzyca (pieczona z warzywami)", ingredients:[{name:"Ciecierzyca z puszki",amount:120,unit:"g"}] },
        { id:"halloumi", label:"Ser halloumi", ingredients:[{name:"Ser halloumi",amount:55,unit:"g"}] },
        { id:"hummus", label:"Hummus (jako dip obok)", ingredients:[{name:"Hummus",amount:65,unit:"g"}] },
        { id:"chorizo", label:"Kiełbasa chorizo", ingredients:[{name:"Kiełbasa chorizo",amount:45,unit:"g"}] },
      ]},
    ],
  },
  { id:"risotto", name:"Risotto lub sos makaronowy", meals:["obiad","lunch","kolacja"], portions:1,
    addonTags:["do_salatek"],
    ...
    fixed:[
      {name:"Cebula",amount:0.5,unit:"sztuka"},
      {name:"Czosnek",amount:1,unit:"ząbek"},
      {name:"Masło lub oliwa",amount:4,unit:"g"},
      {name:"Bulion warzywny",amount:330,unit:"ml"},
      {name:"Parmezan tarty",amount:6,unit:"g"},
      {name:"Mozzarella",amount:55,unit:"g"},
    ],
    variantGroups:[
      { id:"baza", label:"Baza węglowodanowa", options:[
        { id:"ryz", label:"Ryż Arborio", ingredients:[{name:"Ryż Arborio",amount:60,unit:"g"}] },
        { id:"makaron", label:"Makaron", ingredients:[{name:"Makaron (penne / tagliatelle)",amount:60,unit:"g"}] },
      ]},
      { id:"warzywo", label:"Warzywo sezonowe", options:[
        { id:"dynia", label:"Dynia", ingredients:[{name:"Dynia (purée z pieczonej)",amount:135,unit:"g"}] },
        { id:"brokuly", label:"Brokuły", ingredients:[{name:"Brokuły",amount:135,unit:"g"}] },
        { id:"grzyby", label:"Grzyby", ingredients:[{name:"Grzyby (kurki/borowiki/pieczarki)",amount:135,unit:"g"}] },
      ]},
    ],
  },
  { id:"kluseczki_szpinak", name:"Szybkie kluseczki leniwe (ze szpinakiem)", meals:["obiad","lunch","kolacja"], portions:1,
    ...
    fixed:[
      {name:"Twaróg",amount:170,unit:"g"},
      {name:"Mąka pszenna lub orkiszowa",amount:50,unit:"g"},
      {name:"Jajka",amount:1,unit:"sztuka"},
      {name:"Szpinak baby",amount:55,unit:"g"},
      {name:"Masło",amount:5,unit:"g"},
      {name:"Sól",amount:1,unit:"szczypta"},
    ],
    variantGroups:[],
  },
  { id:"tofu_panierka", name:"Tofu w panierce", meals:["obiad","lunch","kolacja"], portions:1,
    ...
    fixed:[
      {name:"Tofu naturalne",amount:145,unit:"g"},
  ...
  { id:"tortilla_gyros", name:"Tortilla gyros", meals:["sniadanie","obiad","lunch","kolacja"], portions:1,
    addonTags:["do_warzyw"],
    ...
    fixed:[
      ...
      {name:"Świeże warzywa (pomidor, ogórek, papryka, sałata)",amount:165,unit:"g"},
      {name:"Surówka (kupna lub domowa)",amount:115,unit:"g"},
    ],
    variantGroups:[
      { id:"bialko", label:"Białko", options:[
        { id:"gyros", label:"Wege-gyros", ingredients:[{name:"Wege zamiennik gyrosa",amount:115,unit:"g"}] },
        { id:"halloumi", label:"Ser halloumi", ingredients:[{name:"Ser halloumi",amount:90,unit:"g"}] },
        { id:"ciecierzyca", label:"Ciecierzyca / fasola", ingredients:[{name:"Ciecierzyca lub fasola z puszki",amount:115,unit:"g"}] },
      ]},
      { id:"feta", label:"Feta i oliwki (opcjonalnie)", options:[
        { id:"brak", label:"Bez", ingredients:[] },
        { id:"tak", label:"Dodaj", ingredients:[{name:"Feta",amount:35,unit:"g"},{name:"Oliwki",amount:5.5,unit:"sztuka"}] },
      ]},
      { id:"kukurydza", label:"Kukurydza (opcjonalnie)", options:[
        { id:"brak", label:"Bez", ingredients:[] },
        { id:"tak", label:"Dodaj", ingredients:[{name:"Kukurydza",amount:45,unit:"g"}] },
      ]},
      { id:"hummus", label:"Hummus (opcjonalnie)", options:[
        { id:"brak", label:"Bez", ingredients:[] },
        { id:"tak", label:"Dodaj", ingredients:[{name:"Hummus",amount:45,unit:"g"}] },
      ]},
  ...
  { id:"zupa_azjatycka", name:"Zupa azjatycka z mrożonych warzyw", meals:["lunch","obiad","kolacja"], portions:2,
    ...
    instructions:["W garnku na suchej dnie podgrzej przez 30 sekund pastę curry z imbirem.", "Wlej wodę/bulion, dodaj liście kaffiru i zagotuj.", "Wrzuć zamrożone warzywa i wybrane białko, gotuj na małym ogniu przez ok. 7-10 minut, aż warzywa będą al dente, a białko się ugotuje/podgrzeje.", "Wlej mleczko kokosowe, sos sojowy i sok z limonki. Wymieszaj, podgrzej (nie gotuj już mocno, by mleczko się nie zwarzyło) i dopraw do smaku. W misce możesz posypać dymką."],
    fixed:[
      {name:"Mieszanka warzyw azjatyckich mrożonych",amount:510,unit:"g"},
      {name:"Mleczko kokosowe",amount:230,unit:"ml"},
      {name:"Liście limonki kaffir",amount:4.5,unit:"sztuka"},
      {name:"Imbir świeży",amount:6,unit:"g"},
      {name:"Sos sojowy",amount:35,unit:"ml"},
      {name:"Sok z limonki",amount:17,unit:"ml"},
      {name:"Pasta curry lub sriracha",amount:6,unit:"g"},
      {name:"Woda lub bulion",amount:565,unit:"ml"},
    ],
    variantGroups:[
      { id:"bialko", label:"Białko", options:[
        { id:"krewetki", label:"Krewetki", ingredients:[{name:"Krewetki (obrane)",amount:230,unit:"g"}] },
        { id:"tofu", label:"Tofu", ingredients:[{name:"Tofu naturalne",amount:230,unit:"g"}] },
        { id:"kurczak", label:"Kurczak (pierś)", ingredients:[{name:"Pierś z kurczaka",amount:230,unit:"g"}] },
      ]},
    ],
  },
];
...
const NUTRITION_DB = {
  ...
  "batat": [1.6, 20, 0.1],
  "bataty": [1.6, 20, 0.1],
  "bazylia świeża": [3, 5, 0.6],
  "brokuły": [2.8, 7, 0.4],
  "bulion warzywny": [0.5, 1, 0],
  "bułka": [9, 51, 3],
  "bułka tarta": [13, 74, 5],
  "cebula": [1.1, 9, 0.1],
  "cebula czerwona": [1.1, 9, 0.1],
  "chili w proszku": [12, 50, 17],
  "chili w płatkach": [2, 7, 0.4],
  "chleb": [8, 49, 3.5],
  "ciecierzyca lub fasola z puszki": [8, 15, 2],
  "ciecierzyca prażona": [8, 16, 4],
  "ciecierzyca z puszki": [8, 16, 2.5],
  "cukier": [0, 100, 0],
  "cukinia": [1.2, 3, 0.3],
  "cukinia (starta, odciśnięta)": [1.2, 3, 0.3],
  "cynamon": [4, 55, 1.2],
  "cytryna": [1.1, 9, 0.3],
  "czekolada gorzka": [7, 45, 42],
  "czosnek": [6.4, 33, 0.5],
  "daktyle (posiekane)": [2.5, 75, 0.4],
  "dymka (zielona cebulka)": [1.8, 7, 0.2],
  "dynia (obrana, kostka)": [1, 6.5, 0.1],
  "dynia (purée z pieczonej)": [1, 6.5, 0.1],
  "ekstrakt z wanilii": [0.1, 12, 0.1],
  "erytrytol": [0, 0, 0],
  "fasola biała (z puszki)": [7, 15, 0.5],
  "fasola czerwona (z puszki)": [8, 14, 0.5],
  "feta": [14, 4, 21],
  "granat (pestki)": [1.7, 19, 1.2],
  "granola": [10, 60, 18],
  "grzyby (kurki/borowiki/pieczarki)": [3, 3, 0.3],
  "halloumi": [21, 2, 25],
  "hummus": [8, 14, 10],
  "imbir świeży": [1.8, 18, 0.8],
  "jajka": [13, 1, 11],
  "jajko": [13, 1, 11],
  "jogurt grecki": [9, 4, 5],
  "jogurt naturalny": [4, 4.5, 3.5],
  "kakao gorzkie": [20, 35, 14],
  "kapusta biała": [1.3, 6, 0.1],
  "kapusta czerwona (poszatkowana)": [1.3, 6, 0.1],
  "kasza gryczana": [13, 71, 3.4],
  "kasza gryczana lub bulgur": [12, 72, 2],
  "kasza jaglana": [11, 73, 4],
  "kiełbasa chorizo": [24, 2, 38],
  "komosa ryżowa": [14, 64, 6],
  ...
  "makaron": [13, 75, 1.5],
  "marchew": [0.9, 10, 0.2],
  "marchew (starta)": [0.9, 10, 0.2],
  "marchew (tarta)": [0.9, 10, 0.2],
  "masło": [0.5, 0.1, 82],
  "masło lub olej": [0.3, 0.1, 90],
  "masło lub oliwa": [0.3, 0.1, 90],
  "masło orzechowe": [25, 20, 50],
  "mieszanka warzyw azjatyckich mrożonych": [2, 7, 0.3],
  "miks warzyw korzeniowych (ziemniaki, buraki, marchew, pietruszka)": [1.7, 15, 0.2],
  "mix sałat": [1.4, 2.9, 0.2],
  "miód": [0.3, 82, 0],
  "miód lub syrop klonowy": [0.2, 75, 0],
  "mleczko kokosowe": [2.3, 6, 24],
  "mleczko kokosowe (light)": [1.5, 3, 8],
  "mleko": [3.4, 4.8, 3.5],
  "mozzarella": [22, 2, 22],
  "mozzarella (starta)": [22, 2, 22],
  "mąka orkiszowa": [13, 70, 2.5],
  "mąka pszenna": [10, 76, 1],
  "mąka pszenna lub orkiszowa": [11, 73, 1.7],
  "mąka pszenna lub owsiana": [12, 68, 4],
  "napój migdałowy bez cukru": [0.5, 0.3, 1.1],
  "napój owsiany": [1, 8, 1.5],
  "napój sojowy": [3.3, 3, 2],
  "nasiona chia": [17, 42, 31],
  "natka pietruszki lub bazylia": [3, 6, 0.8],
  "nerkowce surowe": [18, 30, 44],
  "ocet balsamiczny": [0.5, 17, 0],
  "ogórek": [0.7, 3.6, 0.1],
  "olej / oliwa (do marynaty)": [0, 0, 100],
  "olej lub ghee": [0, 0, 100],
  "olej lub masło": [0.3, 0.1, 90],
  "olej roślinny": [0, 0, 100],
  "olej sezamowy": [0, 0, 100],
  "oliwa lub olej": [0, 0, 100],
  "oliwa z oliwek": [0, 0, 100],
  "oliwa z zalewy suszonych pomidorów": [0, 0, 100],
  "orzechy (posiekane)": [15, 16, 55],
  "orzechy lub pestki dyni": [20, 13, 52],
  "orzechy posiekane": [15, 16, 55],
  ...
  "owoce na wierzch (borówki/maliny)": [1, 12, 0.4],
  "papryczki chili": [2, 7, 0.4],
  "papryka": [1, 6, 0.3],
  "papryka czerwona": [1, 6, 0.3],
  "parmezan tarty": [38, 4, 29],
  "pasta curry": [5, 20, 15],
  "pasta curry lub sriracha": [4, 15, 10],
  "pasta orzechowa": [25, 20, 50],
  "pestki dyni": [30, 11, 49],
  "pieczarki": [3.1, 3.3, 0.3],
  "pierś z kurczaka": [23, 0, 2],
  "pomidor": [0.9, 3.9, 0.2],
  "pomidorki koktajlowe": [0.9, 3.9, 0.2],
  "pomidory krojone (puszka)": [1, 4, 0.2],
  "pomidory krojone (puszka) lub passata": [1, 4, 0.2],
  "pomidory suszone": [2.5, 23, 4],
  "proszek do pieczenia": [0, 28, 0],
  "płatki owsiane": [13, 66, 7],
  "rodzynki": [3.1, 79, 0.5],
  "rukola": [2.6, 3.7, 0.7],
  "rukola lub kiełki": [2.6, 3.7, 0.7],
  "ryż": [7, 79, 0.6],
  "ryż arborio": [7, 79, 0.6],
  "ser halloumi": [21, 2, 25],
  "ser kozi": [19, 2, 21],
  "serek wiejski lekki": [11, 4, 2],
  "sezam prażony": [18, 12, 50],
  "silken tofu": [5, 2, 2.5],
  "skyr naturalny": [11, 4, 0.2],
  "soczewica czerwona": [24, 60, 2],
  "soczewica czerwona (sucha)": [24, 60, 2],
  "sok z limonki": [0.4, 8, 0.2],
  "sos orzechowy": [10, 12, 25],
  "sos sojowy": [8, 8, 0],
  "sos sriracha": [1.5, 12, 0.5],
  "sos tamari lub sojowy": [8, 6, 0],
  "sos vinegrette": [0.5, 3, 85],
  "surówka (kupna lub domowa)": [1, 6, 3],
  "surówka z białej kapusty": [1, 8, 5],
  "surówka: marchewka z sezamem": [1.5, 12, 8],
  ...
  "wędzona papryka (przyprawa)": [2, 15, 1],
  "ziemniak": [2, 20, 0.1],
  "zioła prowansalskie": [10, 50, 6],
  "łosoś (filet)": [20, 0, 13],
  "świeże warzywa (pomidor, ogórek, papryka, sałata)": [1, 4, 0.2],
};
const NUTRITION_PER_UNIT = {
  "banan|sztuka": [1.3, 27, 0.3],
  "bułka|sztuka": [5.4, 31, 1.8],
  "cebula|sztuka": [1.5, 12, 0.1],
  "cebula czerwona|sztuka": [1.5, 12, 0.1],
  "chleb|kromka": [2.4, 15, 1],
  "cytryna|sztuka": [1, 8, 0.3],
  "czosnek|ząbek": [0.2, 1, 0],
  "dymka (zielona cebulka)|sztuka": [0.3, 1, 0],
  "jajka|sztuka": [7.2, 0.5, 6],
  "jajko|sztuka": [7.2, 0.5, 6],
  "kiełbasa chorizo|sztuka": [24, 2, 38],
  "limonka|sztuka": [0.5, 7, 0.1],
  "limonki|sztuka": [0.5, 7, 0.1],
  "liście limonki kaffir|sztuka": [0, 0, 0],
